...
export function useT() {
  ...
  return useMemo(() => {
    ...
    const timestamp = new Intl.DateTimeFormat(locale, { year: "numeric", month: "2-digit", day: "2-digit", hour: "2-digit", minute: "2-digit", second: "2-digit", hour12: false, timeZoneName: "short" });
    const dateTime = (iso: string) => timestamp.format(new Date(iso));
